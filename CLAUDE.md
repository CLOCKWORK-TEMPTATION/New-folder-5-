...
cp .env.example .env   # ثم أضف OPENAI_API_KEY
...
│   ├── package.json
│   └── tsconfig.json
├── 1.md                               # قالب بحث مفصل (Detailed Research Template)
├── 2.md                               # قالب بحث متوسط (Standard Research Template)
└── 3.md                               # قالب بحث مختصر (Brief Research Template)
```
...
- اختيار قالب التقرير المناسب (1.md / 2.md / 3.md)
...
- يجب استخدام قالب التقرير المناسب (1.md / 2.md / 3.md)
...
# سيختار SearchManager قالب التقرير المختصر (3.md)
...
# سيختار SearchManager قالب التقرير المفصل (1.md)
...
جميع الـ system messages مكتوبة وفق أربعة قوالب مرجعية (`1.md`–`4.md`). عند تعديل أي prompt:

- **معايير الإدراج** (`4.md`): أكاديمي محكَّم `.edu/.gov/.org`، رسمي، مؤسسي موثّق
- **معايير الاستبعاد** (`4.md`): مدونات شخصية، Reddit/Quora، محتوى تسويقي، AI Content Farms
- **التمييز الثلاثي** (`2.md`): `[مؤكد]` / `[مرجّح]` / `[غير محسوم]` — إلزامي في كل حقيقة
- **قاعدة المصدرين** (`4.md`): الادعاءات الحاسمة تحتاج مصدرين مستقلين
- **معيار القبول** (`4.md`): Accuracy 20%، Compliance 20%، Cross-Validation 25%، Reliability 15%، Documentation 20% — لا يُسلَّم التقرير إلا بعد استيفائها
...
5. **تحديث القوالب**: تعديل ملفات 1.md/2.md/3.md سيؤثر على بنية التقارير المُولَّدة
