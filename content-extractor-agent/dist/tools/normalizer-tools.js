...
export const normalizeToSchemaTool = tool(async ({ cleanedDocument, cleanedHtml, }) => {
    ...
    description: "Converts cleaned semantic content into the unified JSON schema required by the extraction pipeline.",
    schema: z.object({
